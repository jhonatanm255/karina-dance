        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            >
              ...
              recreativos, culturales y formativos para niños, jóvenes y
              adultos. Impulsado por la Prof. Karina Gutiérrez García, bailarina
              de danza contemporánea y danzas orientales.​ ​ Desde su inicio
              empezó con la participación en diferentes eventos destacando tanto
              a nivel estatal como regional en donde obtuvo destacados
              resultados. Intercolegial de baile televisa Región Sureste,
              Carnaval de Villahermosa, Interjuvenil de baile Tabasco, por
              mencionar algunos.​ ​ En la actualidad se imparten las disciplinas
              de danza jazz, acrodance, danza árabe, danza aérea y sensual
              dance. Contando con un cuerpo de profesores especializados en sus
              aéreas.​ ​ En la Academia de danza Karina Gym ofrecemos clases a
              partir de 3 años, y con un proyecto actual de danza sensual para
              mayores de edad en donde se aprende a ejecutar diversas técnicas.​
              ​ Ven y sé parte de nuestra comunidad Karina Gym.​ <br />
              <br />
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="about-feature text-center p-6 rounded-lg bg-pink-50 hover:bg-pink-100 transition-colors">
              ...
              <p className="text-gray-600">
                Transmitimos el amor por el arte y la danza a cada una de
                nuestras alumnas
              </p>
            </div>
